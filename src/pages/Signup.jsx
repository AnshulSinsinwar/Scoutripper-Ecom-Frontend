        ...
        <div className="min-h-screen" style={{ backgroundColor: '#d4f7f1' }}>
            ...
            <section className="pt-48 pb-20 min-h-screen flex items-center">
                <div className="mx-auto px-4 sm:px-6 w-full" style={{ maxWidth: '681px' }}>
                    {/* Form Card */}
                    <div className="bg-white rounded-lg shadow-sm p-8 md:p-10" style={{ fontFamily: 'Jost, sans-serif' }}>
                        {/* Header */}
                        <h1 className="mb-2" style={{ fontFamily: 'Jost, sans-serif', fontSize: '22px', fontWeight: '500', color: '#0f3d3a' }}>
                            Welcome
                        </h1>
